...
// wave_data_t struct definitions
size_t wav_data_t::searchEdge(size_t offset, size_t search_length) const
{
...
// fft_data_t struct definitions
float fft_data_t::getDataByPixel(uint16_t x, uint16_t width) const
{
  if (length <= width)
  {
...
// fft_function_t class definitions
...
void fft_function_t::close(void)
{
  if (_work_area)
  {
...
bool fft_function_t::update(fft_data_t *fft_data)
{
...
bool fft_function_t::_init(uint8_t size_bits)
{
...
// wav_drawer_t class definitions
...
// fft_drawer_t class definitions
...
bool fft_drawer_t::update(const fft_data_t &fft_data)
{
  auto gfx = _gfx;
...
bool fft_peak_t::update(const fft_data_t &fft_data)
{
  auto gfx = _gfx;
...
bool fft_history_t::update(const fft_data_t &fft_data)
{
  int32_t width = draw_rect.w;
  int32_t height = draw_rect.h;
